...
export function creerInterface() {
  ...
  const contactSelectionne =
    CONTACTS.find((c) => c.selected) ||
    CONTACTS_ARCHIVES.find((c) => c.selected);
  ...
  return createElement(
    "div",
    { id: "whatsapp-container", class: "flex h-screen bg-gray-100 font-sans" },
    [
      creerSidebar(),
      creerSectionDiscussions(),
      createElement(
        "div",
        { class: "flex-1 bg-gray-100 flex flex-col relative" },
        [
          createElement(
            "div",
            {
          ...
          conversationActive
            ...
            : createElement(
                "div",
                { class: "flex-1 flex items-center bg-pink-50 justify-center" },
                [
                  createElement("div", { class: "text-center" }, [
                    createElement(
                      ...
                      {
                        class:
                          "w-32 h-32 bg-gray-300 rounded-full mx-auto mb-4 flex items-center justify-center",
                      },
                      createElement("i", {
                        class: "fas fa-comments text-4xl text-gray-500",
                      })
                    ),
                    createElement(
                      "h2",
                      { class: "text-2xl font-light text-gray-600 mb-2" },
          ...
          createElement(
            "div",
            { class: "absolute top-20 right-4 flex space-x-2" },
                ...
                "button",
                {
                  ...
                  onClick: function () {
                    if (
                      ...
                      if (contactSelectionne) {
                        ...
                        if (groupeEstArchive) {
                          console.log(
                            ...
                            groupeSelectionne.name
                          );
                          desarchiverGroupe(groupeSelectionne.id);
                          afficherMessageValidation(
                            "Groupe désarchivé avec succès",
                            "success"
                          );
                        } else {
                          console.log(
                      ...
                      afficherMessageValidation(
                        "Sélectionnez un contact ou un groupe à archiver",
                        "error"
                      );
                    }
                  },
          ...
          createElement("div", { class: "absolute bottom-6 right-6" }, [
            createElement(
              ...
              {
                class:
                  "w-14 h-14 bg-green-500 rounded-full shadow-lg flex items-center justify-center text-white hover:bg-green-600 transition-colors",
                onClick: function () {
                  if (activeButtonId === "diffusions") {
                    envoyerMessageDiffusion();
                  } else {
                    afficherMessageValidation(
                      "Utilisez ce bouton en mode Diffusions pour envoyer un message groupé !",
                      "error"
                    );
                  }
                },
              ...
              createElement("i", {
                class:
                  activeButtonId === "diffusions"
                    ? "fas fa-paper-plane text-xl"
                    : "fas fa-arrow-right text-xl",
              })
            ),
          ]),
        ]
...
const additionalStyles = createElement(
  "style",
  {},
  `
    .fas, .fa, .fab {
    ...
    /* Animation pour le formulaire de groupe */
    .animate-slideInUp {
