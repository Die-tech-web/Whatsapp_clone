...
function validerTelephone(telephone) {
  ...
  if (numeroNettoye.length > 16) {
    return {
      valide: false,
      message: "Le numéro ne peut pas dépasser 16 chiffres",
    };
  }
...
export function creerInterfaceConnexion() {
  return createElement(
    "div",
    {
      ...
      class:
        "min-h-screen bg-gradient-to-br from-orange-300 via-orange-400 to-amber-600 flex items-center justify-center p-4",
    ...
    [
      createElement(
        ...
        {
          class:
            "bg-white rounded-2xl shadow-2xl p-8 w-full max-w-md transform transition-all",
        },
        [
          createElement("div", { class: "text-center mb-8" }, [
            // Changer la couleur du cercle du logo
            createElement(
              "div",
              {
                class:
                  "w-20 h-20 bg-amber-600 rounded-full mx-auto mb-4 flex items-center justify-center",
              },
              createElement("i", {
                class: "fab fa-whatsapp text-3xl text-white",
              })
            ),
            createElement("h1", {
          ...
          // Modifier les inputs et le bouton
          createElement(
            "form",
            {
              id: "form-connexion",
            ...
            [
              ...
              createElement("div", {}, [
                ...
                createElement("input", {
                  ...
                  id: "prenom",
                  class:
                    "w-full px-4 py-3 border-2 border-orange-300 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-transparent transition-all shadow-md hover:border-orange-400 outline-none", // Ajout de outline-none
                ...
                createElement("input", {
                  ...
                  onInput: function (e) {
                    ...
                    const messageElement =
                      document.getElementById("message-telephone");
              ...
              createElement(
                "button",
                {
                  ...
                  class:
                    "w-full bg-orange-500 hover:bg-orange-600 text-white font-semibold py-3 px-4 rounded-lg transition-all transform hover:scale-105 focus:ring-2 focus:ring-orange-500 focus:ring-offset-2",
                  id: "btn-connexion",
                },
                [
...
function afficherMessage(message, type) {
  ...
  if (type === "succes") {
    btnConnexion.innerHTML =
      '<i class="fas fa-check mr-2"></i>Connexion en cours...';
...
export function creerBoutonDeconnexion() {
  return createElement(
    ...
    {
      class:
        "w-8 h-8 bg-amber-600 hover:bg-amber-700 rounded-full flex items-center justify-center text-white transition-colors shadow-md",
